...
!!! Note
  The details here only apply to Article Harmonisation. Kindly refer to [Content Guidelines Optimisation Node (Article Optimisation)](/content_guidelines_optimisation.md#3-flow-of-content-guidelines-optimisation-node
  ) for details on Content Guidelines Optimisation in Article Optimisation
...
Kindly refer to [here](./content_guidelines_optimisation.md#2-rationale-for-content-guidelines-optimisation-node
) for the flow of Content Guidelines Optimisation Node in article optimisation
